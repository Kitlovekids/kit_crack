...
\033[1;96m
╭────────────────────────────────────────────────────╮
   \033[1;96m[◉] Owner     :   RIZEL GALLARDO\033[1;35m
   \033[1;96m[◉] Github    :   404\033[1;35m
   \033[1;96m[◉] Status    :   TRIAL\033[1;35m
   \033[1;96m[◉] Facebook  :   RIZEL GALLARDO\033[1;35m
   \033[1;96m[◉] Version   :   0.1\033[1;96m         
╰────────────────────────────────────────────────────╯""")
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' \033[1;34m[➣] TOTAL ID TO EXTRACT: \033[1;32m'+total_ids+f' \n \033[1;34m[➣] METHOD : \033[1;37mM{mthd}')
			print(f"\033[1;34m [➣] USE FLIGHT MODE EVERY 3 MINS\033[1;36m")
			print(f"\033[1;34m [➣] PRESS CTRL + Z TO STOP\033[1;36m")
			linex()
			for user in fo:
...
def api1(ids,names,passlist):
                try:
                        global loop,oks,cps
                        sys.stdout.write(f'\r\033[1;96m [RIZEL M1] %s \033[1;32m[ALIVE ➠ %s] \033[1;31m[DEAD ➠ %s] '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
...
def Subscraption():
	...
	clear()
	r1=requests.get("https://github.com/Kitlovekids/kit_crack/blob/main/kit.txt").text
	if key1 in r1:
		os.system('clear')
		print(Spy())
	else:
		...
		print(logo)
		print ("")
		print(" \033[1;32m TOLL IS FREE BUT YOU NEED GET APPROVED FIRST\033[1;37m\n")
		print(" \033[1;32m Note : BAHOG KIGOL   \033[1;37m")
		print ("")
		print(" YOUR KEY IS NOT APPROVED ")
		print("")
		print(" COPY AND SEND KEY TO ADMIN")
		print ("")
		print (" YOUR KEY : "+ah+ak+key1 )
		print ("")
